...
export function NumbersLesson({ onBack }: NumbersLessonProps) {
  ...
  const [selectedNumberLine, setSelectedNumberLine] = useState<number | null>(
    null
  );
  ...
  const [showPatternFeedback, setShowPatternFeedback] = useState<{
    [key: number]: boolean;
  }>({});
  ...
  const resetCounting = (groupIndex: number) => {
    const filtered = countedObjects.filter(
      (k) => Math.floor(k / 100) !== groupIndex
    );
  ...
  const numberLineQuestions = [
    {
      question: 'Find 5 on the number line. Which number is just after it?',
      answer: 6,
      highlight: 5,
    },
    {
      question: 'Jump forward 3 steps from 4. Where do you land?',
      answer: 7,
      highlight: 4,
    },
  ...
  // ✅ Updated so wrong answers never disable buttons,
  // and learners can always try again
  const checkPatternAnswer = (patternId: number, answer: number) => {
    ...
    setShowPatternFeedback((prev) => ({
      ...prev,
      [patternId]: true,
    }));

    // If correct, briefly show celebration then hide the feedback
    ...
    <div className="max-w-7xl mx-auto space-y-8">
      ...
      <div className="bg-gradient-to-br from-blue-500 to-cyan-600 rounded-3xl p-8 shadow-2xl">
        <div className="flex items-center gap-6 mb-6">
          ...
          <div className="flex-1 text-white">
            ...
            <p className="text-white/90">
              Learn to count and recognize numbers 1-20
            </p>
          </div>
        </div>
        ...
        <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20">
          ...
          <p className="text-white/90 mb-4">
            Start your math journey by learning numbers! Count, identify, and
      ...
      <div>
        <div className="mb-6">
          <h2 className="text-slate-800 dark:text-slate-100 mb-2">
            1. Count with Objects
          </h2>
          <p className="text-slate-600 dark:text-slate-400">
            Look at groups of items. Say the number as you count them one by
            one. Match each object to one number.
          </p>
        </div>
        ...
        <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-lg border border-slate-200 dark:border-slate-700 p-8">
          <div className="space-y-8">
            ...
            {objectGroups.map((group, groupIndex) => {
              const countedInGroup = countedObjects.filter(
                (k) => Math.floor(k / 100) === groupIndex
              ).length;
              ...
              return (
                <div
                  key={groupIndex}
                  className="bg-gradient-to-br from-slate-50 to-slate-100 dark:from-slate-900/50 dark:to-slate-800/50 rounded-2xl p-6 border border-slate-200 dark:border-slate-700"
                >
                      ...
                      (_, objectIndex) => {
                        ...
                        return (
                          <button
                            key={objectIndex}
                            onClick={() =>
                              handleObjectClick(groupIndex, objectIndex)
                            }
                  ...
                  <div className="bg-white dark:bg-slate-800 rounded-xl p-6 border-2 border-dashed border-blue-300 dark:border-blue-700">
                    <div className="text-center">
                      ...
                      <div
                        className={`text-6xl mb-2 transition-all ${
                      ...
                      {countedInGroup === group.count && (
                        <div className="flex items-center justify-center gap-2 text-emerald-600 dark:text-emerald-400">
                          ...
                          <span className="text-sm">
                            Perfect! There are {group.count} {group.name}!
                          </span>
                        </div>
                      )}
                      {countedInGroup > 0 &&
                    ...
                    <div className="grid grid-cols-3 gap-4 max-w-md mx-auto">
                      <div className="bg-white/20 rounded-lg p-3">
                        ...
                        <div className="text-2xl text-white">
                          {selectedNumberLine > 0
                            ? selectedNumberLine - 1
                            : '—'}
                        </div>
                      </div>
      ...
      <div>
        <div className="mb-6">
          ...
          <p className="text-slate-600 dark:text-slate-400">
            Discover patterns in numbers! Look at the sequence and find what
            comes next.
          </p>
        </div>
          ...
          <div className="space-y-8">
            ...
            <div className="bg-gradient-to-br from-purple-500 to-pink-600 rounded-2xl p-8 text-white">
              ...
              <p className="text-white/90 mb-6">
                A pattern is when something repeats or follows a special rule.
                Let's look at some number patterns!
              </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/30">
                  <div className="text-center">
                    ...
                    <p className="text-white/90 text-sm">
                      What comes next?{' '}
                      <strong className="text-yellow-300">🔴</strong>
                    </p>
                  </div>
                </div>
                ...
                <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/30">
                  <div className="text-center">
                    ...
                    <p className="text-white/90 text-sm">
                      What comes next?{' '}
                      <strong className="text-yellow-300">4</strong>
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-6">
                {patterns.map((pattern) => {
                  ...
                  const colorClasses = {
                    ...
                    purple:
                      'from-purple-100 to-pink-100 dark:from-purple-900/20 dark:to-pink-900/20 border-purple-200 dark:border-purple-800',
                  ...
                  return (
                    <div
                      ...
                      className={`bg-gradient-to-br ${
                        colorClasses[
                          pattern.color as keyof typeof colorClasses
                        ]
                    ...
                    >
                      ...
                      {/* Answer Options – ALWAYS clickable */}
                      <div className="flex gap-3 justify-center">
                        {pattern.options.map((option) => (
                          <button
                            ...
                            type="button"
                            onClick={() =>
                              checkPatternAnswer(pattern.id, option)
                            }
                      ...
                      {/* Feedback (encouraging, no answer reveal) */}
                      {showPatternFeedback[pattern.id] && (
                        <div
                        ...
                        >
                          ...
                          <p className="text-slate-700 dark:text-slate-300">
                            {isCorrect
                              ...
                              : 'Not quite yet — look at how the numbers are changing and try again!'}
                          </p>
                        </div>
                      )}
                    </div>
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="bg-gradient-to-br from-yellow-100 to-orange-100 dark:from-yellow-900/20 dark:to-orange-900/20 rounded-xl p-6 border border-yellow-200 dark:border-yellow-800">
                  <div className="text-3xl mb-3">🔢</div>
                  <h5 className="text-slate-800 dark:text-slate-100 mb-2">
                    ABC Pattern
                  </h5>
      ...
      <div className="bg-gradient-to-br from-emerald-500 to-emerald-600 rounded-2xl p-8 shadow-lg">
        <div className="flex items-center gap-4 mb-4">
          ...
          <div className="text-white">
            ...
            <p className="text-white/90">
              You've learned about counting, number lines, and comparing
              numbers!
            </p>
          </div>
        </div>
        ...
        <DialogContent className="sm:max-w-md">
          ...
          <DialogHeader>
            ...
            <DialogDescription className="text-center">
              Congratulations! You've successfully completed the Introduction to
              Numbers lesson.
            </DialogDescription>
          </DialogHeader>
          <div className="space-y-4">
            <div className="bg-gradient-to-br from-emerald-50 to-green-50 dark:from-emerald-900/20 dark:to-green-900/20 border border-emerald-200 dark:border-emerald-800/30 rounded-xl p-4">
              ...
              <div className="text-sm text-slate-600 dark:text-slate-400 text-center">
                Great job learning about numbers! You can now count, compare,
                and understand number order!
              </div>
            </div>
          </div>
