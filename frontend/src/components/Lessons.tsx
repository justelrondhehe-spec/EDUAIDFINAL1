    ...
    <div className="max-w-7xl mx-auto space-y-8">
      ...
      {selectedLesson && (
        <LessonDetailModal
          ...
          onStart={() => {
            // Navigate to the lesson content page for specific lessons
            ...
            // Navigate to the lesson content page for Music & Rhythm
            if (selectedLesson.id === 5) {
              onNavigate('lesson-music-rhythm');
            }
            // Navigate to the lesson content page for Reading Basics
            if (selectedLesson.id === 2) {
              onNavigate('lesson-reading-basics');
            }
            // Navigate to the lesson content page for Science Exploration
            if (selectedLesson.id === 3) {
              onNavigate('lesson-science-exploration');
            }
            // Navigate to the lesson content page for Our Emotions
